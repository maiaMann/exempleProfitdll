...
namespace ProfitDLL
{
    ...
    partial class DLLConnector
    {
        ...
        //////////////////////////////////////////////////////////////////////////////
        // Error Codes
        public const sbyte NL_ERR_INIT = 80;
        public const sbyte NL_OK = 0;
        public const sbyte NL_ERR_INVALID_ARGS = 90;
        public const sbyte NL_ERR_INTERNAL_ERROR = 100;
        ...
        public static extern sbyte DLLInitializeMarketLogin(
        ...
        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte GetAllTicker([MarshalAs(UnmanagedType.LPWStr)] string pwcBolsa);

        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte SetServerAndPort(
            [MarshalAs(UnmanagedType.LPWStr)] string strServer,
            [MarshalAs(UnmanagedType.LPWStr)] string strPort);

        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte GetServerClock(
            ref double serverClock,
            ref int nYear, ref int nMonth, ref int nDay, ref int nHour, ref int nMin, ref int nSec, ref int nMilisec);

        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte GetLastDailyClose(
        ...
        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte SetChangeCotationCallback(TChangeCotation a_ChangeCotation);

        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte SetAssetListCallback(TAssetListCallback AssetListCallback);

        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte SetAssetListInfoCallback(TAssetListInfoCallback AssetListInfoCallback);

        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte SetAssetListInfoCallbackV2(TAssetListInfoCallbackV2 AssetListInfoCallbackV2);

        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte SetChangeStateTickerCallback(TChangeStateTickerCallback a_changeStateTickerCallback);

        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte SetTheoreticalPriceCallback(TTheoreticalPriceCallback a_theoreticalPriceCallback);

        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte SetAdjustHistoryCallbackV2(TAdjustHistoryCallbackV2 AdjustHistoryCallbackV2);

        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte SetEnabledLogToDebug(int bEnabled);

        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte SubscribeTicker(
            [MarshalAs(UnmanagedType.LPWStr)] string pwcTicker,
            [MarshalAs(UnmanagedType.LPWStr)] string pwcBolsa);

        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte UnsubscribeTicker(
            [MarshalAs(UnmanagedType.LPWStr)] string pwcTicker,
            [MarshalAs(UnmanagedType.LPWStr)] string pwcBolsa);

        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte SubscribePriceBook(
            [MarshalAs(UnmanagedType.LPWStr)] string pwcTicker,
            [MarshalAs(UnmanagedType.LPWStr)] string pwcBolsa);

        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte UnsubscribePriceBook(
            [MarshalAs(UnmanagedType.LPWStr)] string pwcTicker,
            [MarshalAs(UnmanagedType.LPWStr)] string pwcBolsa);

        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte SubscribeOfferBook(
            [MarshalAs(UnmanagedType.LPWStr)] string pwcTicker,
            [MarshalAs(UnmanagedType.LPWStr)] string pwcBolsa);

        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte UnsubscribeOfferBook(
            [MarshalAs(UnmanagedType.LPWStr)] string pwcTicker,
            [MarshalAs(UnmanagedType.LPWStr)] string pwcBolsa);

        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte SubscribeAdjustHistory(
            [MarshalAs(UnmanagedType.LPWStr)] string pwcTicker,
            [MarshalAs(UnmanagedType.LPWStr)] string pwcBolsa);

        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte GetHistoryTrades(
            [MarshalAs(UnmanagedType.LPWStr)] string pwcTicker,
            [MarshalAs(UnmanagedType.LPWStr)] string pwcBolsa,
        ...
        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte FreePointer(IntPtr pointer, int nSize);
        ...
        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte SendChangeOrder(
            [MarshalAs(UnmanagedType.LPWStr)] string pwcIDAccount,
            [MarshalAs(UnmanagedType.LPWStr)] string pwcIDCorretora,
            [MarshalAs(UnmanagedType.LPWStr)] string sSenha,
        ...
        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte SendCancelOrder(
            [MarshalAs(UnmanagedType.LPWStr)] string pwcIDAccount,
            [MarshalAs(UnmanagedType.LPWStr)] string pwcIDCorretora,
            [MarshalAs(UnmanagedType.LPWStr)] string pwcClOrdID,
            [MarshalAs(UnmanagedType.LPWStr)] string sSenha);
        ...
        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte SendCancelAllOrders(
            [MarshalAs(UnmanagedType.LPWStr)] string pwcIDAccount,
            [MarshalAs(UnmanagedType.LPWStr)] string pwcIDCorretora,
            [MarshalAs(UnmanagedType.LPWStr)] string sSenha);

        [DllImport(dll_path, CallingConvention = CallingConvention.StdCall)]
        public static extern sbyte SendCancelOrders(
            [MarshalAs(UnmanagedType.LPWStr)] string pwcIDAccount,
            [MarshalAs(UnmanagedType.LPWStr)] string pwcIDCorretora,
            [MarshalAs(UnmanagedType.LPWStr)] string sSenha,
            [MarshalAs(UnmanagedType.LPWStr)] string pwcTicker,
        ...
        private static void RequestInfo()
        {
            ...
            var retVal = GetAllTicker(split[1]);

            if (retVal == NL_OK)
            {
                Console.WriteLine("Pedido executado com sucesso");
            }
            else
            {
                Console.WriteLine($"Erro no GetAllTicker: {retVal}");
            }
        }
        ...
        private static sbyte StartDLL(string key, string user, string password)
        {
