...
begin
  GenericLogUpdate(Format('THistoryCallbaclk: %s | %d | %d | %n | %s | %s | %s', [rAssetId.pchTicker, nTradedQtd, nSide, sPrice, Conta, ClOrdId, Status] ));
end;
...
begin
  ...
  UpdatePriceBook(rAssetID, nAction, nPosition, Side, nQtds, nCount, sPrice, pArraySell, pArrayBuy);
end;
...
begin
  ...
  UpdateOfferBook(rAssetID, nAction, nPosition, Side, nQtd, nAgent, nOfferID, sPrice, bHasPrice, bHasQtd, bHasDate, bHasOfferID, bHasAgent, pwcDate, pArraySell, pArrayBuy);
end;
